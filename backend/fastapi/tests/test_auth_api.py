...
class TestAuthEndpoints:
    ...
    def test_register_admin_success(self, client: TestClient, admin_user_data):
    ...
    def test_register_docente_success(self, client: TestClient, docente_user_data):
        """Test registro exitoso de docente"""
        response = client.post("/api/auth/register", json=docente_user_data.model_dump())
    ...
    def test_register_estudiante_success(self, client: TestClient, estudiante_user_data):
        """Test registro exitoso de estudiante"""
        response = client.post("/api/auth/register", json=estudiante_user_data.model_dump())
    ...
    def test_register_duplicate_email(self, client: TestClient, admin_user_data):
    ...
    def test_login_success(self, client: TestClient, admin_user_data):
        """Test login exitoso"""
    ...
    def test_login_json_success(self, client: TestClient, admin_user_data):
    ...
    def test_login_wrong_password(self, client: TestClient, admin_user_data):
    ...
    def test_get_current_user_success(self, client: TestClient, auth_headers_admin, admin_user_data):
    ...
    def test_refresh_token_success(self, client: TestClient, admin_user_data):
    ...
    def test_validate_role_insufficient_permissions(self, client: TestClient, auth_headers_estudiante):
        """Test validación de rol con permisos insuficientes"""
        response = client.get("/api/auth/validate-role/administrador", headers=auth_headers_estudiante)
...
class TestAuthenticationFlow:
    ...
    def test_token_expiration_handling(self, client: TestClient, admin_user_data):
