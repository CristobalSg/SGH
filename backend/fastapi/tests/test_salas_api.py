...
class TestSalasEndpoints:
    ...
    def test_get_sala_by_id_success(self, client: TestClient, auth_headers_admin, edificio_completo):
    ...
    def test_get_salas_by_edificio(self, client: TestClient, auth_headers_admin, edificio_completo):
        ...
        response = client.get(f"/api/salas/edificio/{edificio_completo['id']}", headers=auth_headers_admin)
...
class TestSalasValidation:
    ...
    def test_capacidad_validation_range(self, client: TestClient, auth_headers_admin, edificio_completo):
    ...
    def test_capacidad_validation_invalid(self, client: TestClient, auth_headers_admin, edificio_completo):
    ...
    def test_disponible_default_true(self, client: TestClient, auth_headers_admin, edificio_completo):
...
class TestSalasFiltering:
    ...
    def test_filter_by_capacidad_minima(self, client: TestClient, auth_headers_admin, edificio_completo):
        """Test filtrar salas por capacidad mínima"""
        # Crear salas con diferentes capacidades
        salas = [
            {"codigo": "SMALL1", "capacidad": 10, "tipo": "Aula", "edificio_id": edificio_completo["id"]},
            {"codigo": "MED1", "capacidad": 30, "tipo": "Aula", "edificio_id": edificio_completo["id"]},
            {"codigo": "BIG1", "capacidad": 100, "tipo": "Auditorio", "edificio_id": edificio_completo["id"]}
        ]
    ...
    def test_search_by_equipamiento(self, client: TestClient, auth_headers_admin, edificio_completo):
