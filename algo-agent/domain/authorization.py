...
class AuthorizationRules:
    ...
    @staticmethod
    def can_modify_restriccion(actor_role: UserRole, actor_docente_id: Optional[int], 
                               restriccion_docente_id: int) -> bool:
        """
    ...
    def can_create_resource(actor_role: UserRole, resource_type: str) -> bool:
        ...
        admin_only_resources = [
            "user", "docente", "estudiante", "asignatura", 
            "seccion", "sala", "campus", "edificio", "bloque", "clase"
        ]
...
class OwnershipRequiredError(AuthorizationError):
    ...
    def __init__(self, resource_type: str):
        ...
        super().__init__(
            f"Solo el propietario puede acceder a este {resource_type}"
        )
